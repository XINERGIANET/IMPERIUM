...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        'from_seller_id' => 'asesor comercial origen',
        'from_payment_method_id' => 'método de pago origen',
        'group_name' => 'nombre de grupo',
        'home_type' => 'tipo de vivienda',
        'husband_document' => 'dni de esposo',
        'husband_name' => 'nombre de esposo',
        ...
        'number' => 'número',
        'parents_name' => 'nombre del padre/madre',
        'party_date' => 'fecha de fiesta',
        'party_time' => 'hora de fiesta',
        'password' => 'contraseña',
        'payment_method_id' => 'método de pago',
        'payment_method_id_1' => 'método de pago 1',
        'payment_method_id_2' => 'método de pago 2',
        'phone' => 'teléfono',
        'price' => 'precio',
        'product' => 'producto',
        'product_id' => 'producto',
        'qty_store_1.*' => 'cantidad sede 1',
        'qty_store_2.*' => 'cantidad sede 2',
        'qty_store_3.*' => 'cantidad sede 3',
        'qty_delivery.*' => 'cantidad delivery',
        'quantity' => 'cantidad',
        'quota_id' => 'cuota',
        'reason' => 'motivo',
        ...
        'seller_id' => 'asesor comercial',
        'service_id' => 'servicio',
        'store_id' => 'sede',
        'to_seller_id' => 'asesor comercial destino',
        'to_payment_method_id' => 'método de pago destino',
        'total_open' => 'total',
        'total_close' => 'total',
        'turn' => 'turno',
        'type' => 'tipo',
